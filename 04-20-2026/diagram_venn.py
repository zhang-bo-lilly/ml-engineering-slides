...
air_avatar = tint_avatar('Picture1.png', EMERALD)
dc_avatar  = tint_avatar('Picture1.png', BLUE)
...
plt.savefig('diagram_venn.png', dpi=200, facecolor=LIGHT_BG, bbox_inches='tight')
